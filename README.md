...
5. **Security & Privacy** – All client health data shall be stored securely with  role-based authorization ensuring trainers can only access data of their assigned clients, and clients cannot access other clients' data. User passwords shall be hashed using sha256 hash algorithm.
